...
def prune(args):
    ...
    pruning_cfg['data'] = "E:/ultralytics-main/CS2.v1i.yolov8/data.yaml"
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model', default='E:/ultralytics-main/runs/detect/train23/weights/last.pt', help='Pretrained pruning target model file')
